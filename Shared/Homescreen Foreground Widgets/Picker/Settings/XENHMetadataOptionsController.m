...
-(instancetype)initWithOptions:(NSDictionary*)options fallbackState:(BOOL)state andPlist:(NSArray*)plist {
    ...
    if (self) {
        _options = options != nil ? [options mutableCopy] : [@{} mutableCopy];
        _plist = plist;
...
- (void)doneClicked:(id)sender {
    ...
    [self.delegate didChooseWidget:self.widgetURL withMetadata:_options fallbackState:self.fallbackState];
}
