...
- (void)setup {
    if (!self.textField) {
        ...
        if (@available(iOS 13.0, *)) {
            ...
            self.textField.layer.borderColor = [UIColor systemGray5Color].CGColor;
            self.textField.backgroundColor = [UIColor systemGray5Color];
        } else {
            self.textField.textColor = [UIColor darkTextColor];
            self.textField.layer.borderColor = [UIColor colorWithWhite:(229.0 / 255.0) alpha:1.0].CGColor;
