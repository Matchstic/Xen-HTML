...
@class WKWebView; @class SpringBoard; @class SBDockView; @class SBIdleTimerGlobalStateMonitor; @class UITouch; @class SBCoverSheetWindow; @class WKContentView; @class SBFLockScreenDateView; @class XENDashBoardWebViewController; @class SBScreenWakeAnimationController; @class SBMainWorkspace; @class CSCoverSheetViewController; @class SBIconScrollView; @class CSPageViewController; @class SBFolderIconImageView; @class SBUIProudLockIconView; @class SBLockScreenManager; @class CSScrollView; @class SBFloatingDockPlatterView; @class CSCoverSheetView; @class SBHomeScreenPreviewView; @class SBIconListPageControl; @class SBMainStatusBarStateProvider; @class SBHomeScreenViewController; @class CSTeachableMomentsContainerView; @class SBDashBoardLockScreenEnvironment; @class UIWKTextLoupeInteraction; @class CSFixedFooterView; @class CSMainPageContentViewController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class UITouchesEvent; @class SBRootFolderView; @class CSCombinedListViewController; @class SBHorizontalScrollFailureRecognizer; @class SBRootFolderController; @class CSMainPageView; @class _UIPlatterView; @class SBHomeScreenView; @class SBIconView; @class _UIContextMenuActionsListView; @class SBIconListView; @class SBHomeScreenOverlayViewController; @class CSQuickActionsViewController; @class SBBacklightController; 
