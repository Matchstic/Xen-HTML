...
@class UITouchesEvent; @class SBHomeScreenWindow; @class _UIPlatterView; @class SBIconListView; @class CSTeachableMomentsContainerView; @class CSMainPageView; @class SBHorizontalScrollFailureRecognizer; @class XENDashBoardWebViewController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBRootFolderController; @class CSMainPageContentViewController; @class SBDockView; @class SBLockScreenManager; @class SBIdleTimerGlobalStateMonitor; @class SBCoverSheetWindow; @class SBFLockScreenDateView; @class SBUIProudLockIconView; @class SBScreenWakeAnimationController; @class SBIconScrollView; @class SBRootFolderView; @class WKWebView; @class CSCombinedListViewController; @class UIWKTextLoupeInteraction; @class SBHomeScreenView; @class SpringBoard; @class SBBacklightController; @class SBIconListPageControl; @class CSCoverSheetView; @class SBFloatingDockPlatterView; @class SBFolderIconImageView; @class SBHomeScreenPreviewView; @class SBMainStatusBarStateProvider; @class CSFixedFooterView; @class SBMainWorkspace; @class SBIconView; @class UITouch; @class CSCoverSheetViewController; @class SBHomeScreenViewController; @class CSQuickActionsViewController; @class CSScrollView; @class CSPageViewController; 
