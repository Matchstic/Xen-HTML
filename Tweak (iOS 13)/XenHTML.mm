...
@class SBMainStatusBarStateProvider; @class XENDashBoardWebViewController; @class SBFLockScreenDateView; @class SBRootFolderView; @class CSCoverSheetViewController; @class SBLockScreenManager; @class SBHomeScreenView; @class SBHomeScreenViewController; @class SBBacklightController; @class UITouchesEvent; @class CSMainPageView; @class SBUIProudLockIconView; @class SBDashBoardLockScreenEnvironment; @class SBHomeScreenWindow; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBIconListView; @class _UIContextMenuActionsListView; @class WKWebView; @class SBFolderIconImageView; @class SBHomeScreenOverlayViewController; @class SBCoverSheetWindow; @class WKContentView; @class SBScreenWakeAnimationController; @class CSPageViewController; @class SBIdleTimerGlobalStateMonitor; @class CSCombinedListViewController; @class UIWKTextLoupeInteraction; @class CSQuickActionsViewController; @class SBRootFolderController; @class SBMainWorkspace; @class SBFloatingDockPlatterView; @class _UIPlatterView; @class CSMainPageContentViewController; @class CSTeachableMomentsContainerView; @class SBIconListPageControl; @class SBIconScrollView; @class UITouch; @class CSScrollView; @class CSCoverSheetView; @class SBHomeScreenPreviewView; @class SBDockView; @class SpringBoard; @class SBHorizontalScrollFailureRecognizer; @class CSFixedFooterView; @class SBIconView; 


#line 50 "/Users/matt/iOS/Projects/Xen-HTML/Tweak (iOS 13)/XenHTML.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_e654ed6e(int __unused argc, char __unused **argv, char __unused **envp) {
