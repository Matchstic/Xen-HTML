...
@class UITouchesEvent; @class SBHomeScreenWindow; @class SBFloatingDockPlatterView; @class SBHomeScreenPreviewView; @class SBIdleTimerGlobalStateMonitor; @class _UIPlatterView; @class SBIconView; @class SBHomeScreenView; @class CSMainPageView; @class SBDockView; @class CSCombinedListViewController; @class SpringBoard; @class SBRootFolderController; @class CSCoverSheetViewController; @class SBMainStatusBarStateProvider; @class SBHorizontalScrollFailureRecognizer; @class CSQuickActionsViewController; @class UIWKTextLoupeInteraction; @class SBFolderIconImageView; @class SBIconListView; @class XENDashBoardWebViewController; @class WKWebView; @class SBMainWorkspace; @class CSScrollView; @class SBHomeScreenViewController; @class SBIconScrollView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class UITouch; @class CSTeachableMomentsContainerView; @class SBBacklightController; @class SBRootFolderView; @class SBFLockScreenDateView; @class SBLockScreenManager; @class SBIconListPageControl; @class CSCoverSheetView; @class SBCoverSheetWindow; @class SBScreenWakeAnimationController; @class SBUIProudLockIconView; @class CSMainPageContentViewController; @class CSPageViewController; @class CSFixedFooterView; 
