...
@class SpringBoard; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBRootFolderView; @class SBHomeScreenViewController; @class CSMainPageView; @class WKWebView; @class SBScreenWakeAnimationController; @class UIWKTextLoupeInteraction; @class SBHorizontalScrollFailureRecognizer; @class CSMainPageContentViewController; @class SBHomeScreenPreviewView; @class SBHomeScreenView; @class SBIconListView; @class SBIconView; @class UITouch; @class SBHomeScreenWindow; @class SBFolderIconImageView; @class XENDashBoardWebViewController; @class SBLockScreenManager; @class CSQuickActionsViewController; @class CSCombinedListViewController; @class SBIconScrollView; @class SBMainWorkspace; @class CSFixedFooterView; @class SBUIProudLockIconView; @class SBDockView; @class SBIconListPageControl; @class UITouchesEvent; @class SBMainStatusBarStateProvider; @class SBFLockScreenDateView; @class SBFloatingDockPlatterView; @class SBBacklightController; @class CSScrollView; @class CSTeachableMomentsContainerView; @class SBRootFolderController; @class CSCoverSheetViewController; @class SBCoverSheetWindow; @class SBIdleTimerGlobalStateMonitor; @class CSCoverSheetView; @class _UIPlatterView; @class CSPageViewController; 
...
static __attribute__((constructor)) void _logosLocalCtor_04fc5a3f(int __unused argc, char __unused **argv, char __unused **envp) {
