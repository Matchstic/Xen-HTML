...
@class SBFolderIconImageView; @class SBHorizontalScrollFailureRecognizer; @class SBIdleTimerGlobalStateMonitor; @class SpringBoard; @class SBLockScreenManager; @class _UIContextMenuActionsListView; @class CSCombinedListViewController; @class CSMainPageContentViewController; @class WKWebView; @class XENDashBoardWebViewController; @class CSScrollView; @class SBHomeScreenOverlayViewController; @class UIWKTextLoupeInteraction; @class CSCoverSheetView; @class _UIPlatterView; @class CSFixedFooterView; @class WKContentView; @class SBIconScrollView; @class SBHomeScreenViewController; @class SBRootFolderController; @class SBScreenWakeAnimationController; @class SBIconView; @class SBUIProudLockIconView; @class SBFLockScreenDateView; @class SBFloatingDockPlatterView; @class UITouchesEvent; @class CSPageViewController; @class SBBacklightController; @class SBHomeScreenPreviewView; @class CSTeachableMomentsContainerView; @class SBCoverSheetWindow; @class CSMainPageView; @class CSQuickActionsViewController; @class SBRootFolderView; @class SBMainStatusBarStateProvider; @class CSCoverSheetViewController; @class SBDashBoardLockScreenEnvironment; @class SBIconListView; @class UITouch; @class SBDockView; @class SBHomeScreenView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBMainWorkspace; @class SBIconListPageControl; 
