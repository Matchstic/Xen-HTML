...
@class SBMainWorkspace; @class _UIContextMenuActionsListView; @class SBFloatingDockPlatterView; @class SBScreenWakeAnimationController; @class UIWKTextLoupeInteraction; @class SBIconListPageControl; @class CSFixedFooterView; @class SBLockScreenManager; @class SBHorizontalScrollFailureRecognizer; @class SBHomeScreenViewController; @class SBHomeScreenOverlayViewController; @class SBHomeScreenWindow; @class SBMainStatusBarStateProvider; @class SBHomeScreenPreviewView; @class SBCoverSheetWindow; @class SBFluidSwitcherGestureWorkspaceTransaction; @class _UIPlatterView; @class SBDockView; @class CSMainPageView; @class CSPageViewController; @class XENDashBoardWebViewController; @class CSMainPageContentViewController; @class WKContentView; @class SBIconScrollView; @class SBRootFolderController; @class WKWebView; @class UITouch; @class CSQuickActionsViewController; @class CSScrollView; @class SBBacklightController; @class SBFolderIconImageView; @class SBIconListView; @class SBRootFolderView; @class CSTeachableMomentsContainerView; @class CSCoverSheetView; @class SBIconView; @class SBIdleTimerGlobalStateMonitor; @class SBUIProudLockIconView; @class SBHomeScreenView; @class SpringBoard; @class CSCombinedListViewController; @class UITouchesEvent; @class CSCoverSheetViewController; @class SBFLockScreenDateView; 
...
static void _logos_method$SpringBoard$SBHomeScreenViewController$_animateTransitionToSize$andInterfaceOrientation$withTransitionContext$(_LOGOS_SELF_TYPE_NORMAL SBHomeScreenViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, CGSize size, int orientation, id transitionContext) {
    ...
    if ([XENHResources SBEnabled] && [self shouldAutorotate]) {
        XENlog(@"ANIMATE ROTATE TO ORIENTATION %d", orientation);
...
static void _logos_method$SpringBoard$SBHomeScreenViewController$_prepareForTransitionToSize$andInterfaceOrientation$withTransitionCoordinator$(_LOGOS_SELF_TYPE_NORMAL SBHomeScreenViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, CGSize arg1, long long orientation, id arg3) {
    ...
    if ([XENHResources SBEnabled] && [self shouldAutorotate]) {
        XENlog(@"ROTATING TO ORIENTATION %d", orientation);
...
static __attribute__((constructor)) void _logosLocalCtor_6710fd3a(int __unused argc, char __unused **argv, char __unused **envp) {
