...
@class SBFloatingDockPlatterView; @class SBUIProudLockIconView; @class CSMainPageContentViewController; @class SBHomeScreenPreviewView; @class SBMainWorkspace; @class SBIconListView; @class SBIdleTimerGlobalStateMonitor; @class SBFLockScreenDateView; @class SBHomeScreenWindow; @class SBHorizontalScrollFailureRecognizer; @class SBMainStatusBarStateProvider; @class SBDockView; @class XENDashBoardWebViewController; @class CSCoverSheetView; @class WKWebView; @class SpringBoard; @class SBHomeScreenViewController; @class SBBacklightController; @class CSMainPageView; @class SBFolderIconImageView; @class SBApplication; @class SBCoverSheetWindow; @class UIWKTextLoupeInteraction; @class CSTeachableMomentsContainerView; @class SBHomeScreenView; @class CSQuickActionsViewController; @class SBIconScrollView; @class SBIconView; @class _UIPlatterView; @class CSScrollView; @class UITouch; @class SBRootFolderController; @class SBMainSwitcherViewController; @class CSFixedFooterView; @class SBRootFolderView; @class SBLockScreenManager; @class SBScreenWakeAnimationController; @class UITouchesEvent; @class CSCoverSheetViewController; @class SBIconListPageControl; @class CSCombinedListViewController; @class CSPageViewController; @class SBFluidSwitcherGestureWorkspaceTransaction; 
...
static SBFolderIconImageView* _logos_method$SpringBoard$SBFolderIconImageView$initWithFrame$(_LOGOS_SELF_TYPE_INIT SBFolderIconImageView* __unused self, SEL __unused _cmd, CGRect arg1) _LOGOS_RETURN_RETAINED {
    ...
    XENlog(@"SBFolderIconImageView initWithFrame");
...
static __attribute__((constructor)) void _logosLocalCtor_0e31d99c(int __unused argc, char __unused **argv, char __unused **envp) {
