...
@class SBFolderIconImageView; @class SBScreenWakeAnimationController; @class SBLockScreenManager; @class SBIconListView; @class SBHorizontalScrollFailureRecognizer; @class WKWebView; @class SBIconView; @class SBMainWorkspace; @class WKContentView; @class SBHomeScreenOverlayViewController; @class CSCoverSheetView; @class CSMainPageContentViewController; @class SBIconListPageControl; @class SBIdleTimerGlobalStateMonitor; @class XENDashBoardWebViewController; @class _UIContextMenuActionsListView; @class SBHomeScreenPreviewView; @class SBDockView; @class SBHomeScreenWindow; @class SBRootFolderView; @class UITouchesEvent; @class _UIPlatterView; @class SBCoverSheetWindow; @class SBIconScrollView; @class CSCombinedListViewController; @class SBUIProudLockIconView; @class CSPageViewController; @class SBHomeScreenView; @class CSTeachableMomentsContainerView; @class SBFloatingDockPlatterView; @class SBBacklightController; @class CSQuickActionsViewController; @class CSFixedFooterView; @class UITouch; @class SBMainStatusBarStateProvider; @class CSMainPageView; @class SpringBoard; @class CSScrollView; @class SBHomeScreenViewController; @class CSCoverSheetViewController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBRootFolderController; @class UIWKTextLoupeInteraction; @class SBFLockScreenDateView; 
...
static __attribute__((constructor)) void _logosLocalCtor_00f1af3f(int __unused argc, char __unused **argv, char __unused **envp) {
