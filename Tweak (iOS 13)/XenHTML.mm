...
@class _UIPlatterView; @class CSCoverSheetViewController; @class CSTeachableMomentsContainerView; @class SBMainStatusBarStateProvider; @class XENDashBoardWebViewController; @class CSFixedFooterView; @class SpringBoard; @class SBIconScrollView; @class SBRootFolderController; @class UITouchesEvent; @class SBIconListView; @class UIWKTextLoupeInteraction; @class UITouch; @class SBHomeScreenView; @class SBIconListPageControl; @class SBIconView; @class SBFloatingDockPlatterView; @class SBHomeScreenWindow; @class SBDockView; @class CSScrollView; @class WKWebView; @class SBBacklightController; @class SBHomeScreenPreviewView; @class SBFLockScreenDateView; @class SBIdleTimerGlobalStateMonitor; @class SBRootFolderView; @class SBHorizontalScrollFailureRecognizer; @class CSPageViewController; @class SBCoverSheetWindow; @class SBScreenWakeAnimationController; @class CSQuickActionsViewController; @class SBUIProudLockIconView; @class SBFolderIconImageView; @class CSCombinedListViewController; @class SBLockScreenManager; @class CSMainPageView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBHomeScreenViewController; @class CSCoverSheetView; @class CSMainPageContentViewController; @class SBMainWorkspace; 
