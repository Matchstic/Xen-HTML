...
@class SBFluidSwitcherGestureWorkspaceTransaction; @class SBRootFolderController; @class CSPageViewController; @class SBUIProudLockIconView; @class CSFixedFooterView; @class CSCombinedListViewController; @class SBIdleTimerGlobalStateMonitor; @class XENDashBoardWebViewController; @class UIWKTextLoupeInteraction; @class UITouchesEvent; @class CSMainPageContentViewController; @class SBScreenWakeAnimationController; @class SBIconListPageControl; @class _UIPlatterView; @class CSTeachableMomentsContainerView; @class SBFLockScreenDateView; @class SBHomeScreenViewController; @class SBFolderIconImageView; @class SpringBoard; @class SBHorizontalScrollFailureRecognizer; @class CSScrollView; @class SBLockScreenManager; @class SBIconScrollView; @class CSCoverSheetViewController; @class WKWebView; @class CSCoverSheetView; @class SBCoverSheetWindow; @class CSMainPageView; @class UITouch; @class SBIconListView; @class SBMainStatusBarStateProvider; @class SBFloatingDockPlatterView; @class SBHomeScreenWindow; @class SBMainWorkspace; @class SBHomeScreenView; @class SBIconView; @class CSQuickActionsViewController; @class SBDockView; @class SBRootFolderView; @class SBBacklightController; @class SBHomeScreenPreviewView; 
