...
@class SBIconScrollView; @class CSQuickActionsViewController; @class CSCombinedListViewController; @class WKWebView; @class SBIdleTimerDefaults; @class _UIPlatterView; @class SBBacklightController; @class SBIconView; @class SBMainSwitcherViewController; @class SBFloatingDockPlatterView; @class CSScrollView; @class SBFLockScreenDateView; @class UITouchesEvent; @class XENDashBoardWebViewController; @class CSCoverSheetView; @class SBRootFolderView; @class SBMainStatusBarStateProvider; @class CSCoverSheetViewController; @class UIWKTextLoupeInteraction; @class SpringBoard; @class CSTeachableMomentsContainerView; @class SBHomeScreenPreviewView; @class SBIconListPageControl; @class SBHorizontalScrollFailureRecognizer; @class CSFixedFooterView; @class SBScreenWakeAnimationController; @class SBMainWorkspace; @class SBRootFolderController; @class CSMainPageView; @class SBCoverSheetWindow; @class UITouch; @class SBLockScreenManager; @class SBHomeScreenWindow; @class SBUIProudLockIconView; @class SBDockView; @class SBApplication; @class SBHomeScreenViewController; @class CSMainPageContentViewController; @class CSPageViewController; @class SBRootIconListView; @class SBHomeScreenView; @class SBFolderIconBackgroundView; @class SBFluidSwitcherGestureWorkspaceTransaction; 
...
static __attribute__((constructor)) void _logosLocalCtor_8507e470(int __unused argc, char __unused **argv, char __unused **envp) {
