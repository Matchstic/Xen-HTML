...
@class SBRootFolderController; @class SBDockView; @class CSPageViewController; @class SBRootFolderView; @class SBIdleTimerGlobalStateMonitor; @class CSMainPageContentViewController; @class SBLockScreenManager; @class SBHomeScreenViewController; @class SBMainStatusBarStateProvider; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBUIProudLockIconView; @class SBIconView; @class SBFloatingDockPlatterView; @class SBHomeScreenWindow; @class SBFolderIconImageView; @class CSTeachableMomentsContainerView; @class UIWKTextLoupeInteraction; @class CSCoverSheetViewController; @class XENDashBoardWebViewController; @class SBHomeScreenView; @class _UIPlatterView; @class WKWebView; @class CSCoverSheetView; @class CSMainPageView; @class SBMainWorkspace; @class SBFLockScreenDateView; @class SBIconListView; @class SBIconScrollView; @class SBHomeScreenPreviewView; @class CSCombinedListViewController; @class SBScreenWakeAnimationController; @class CSScrollView; @class SpringBoard; @class UITouch; @class CSQuickActionsViewController; @class SBIconListPageControl; @class SBBacklightController; @class CSFixedFooterView; @class UITouchesEvent; @class SBCoverSheetWindow; @class SBHorizontalScrollFailureRecognizer; 
