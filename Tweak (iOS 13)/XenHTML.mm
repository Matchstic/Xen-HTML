...
@class WKWebView; @class SBRootFolderView; @class SBIdleTimerGlobalStateMonitor; @class SBMainWorkspace; @class CSQuickActionsViewController; @class SBMainStatusBarStateProvider; @class CSTeachableMomentsContainerView; @class SBFLockScreenDateView; @class SBHomeScreenPreviewView; @class SBLockScreenManager; @class CSFixedFooterView; @class SBIconListPageControl; @class SBHomeScreenView; @class UITouch; @class CSMainPageContentViewController; @class SBIconListView; @class SBScreenWakeAnimationController; @class CSPageViewController; @class SpringBoard; @class XENDashBoardWebViewController; @class SBHomeScreenViewController; @class CSCoverSheetView; @class CSMainPageView; @class CSCoverSheetViewController; @class SBBacklightController; @class CSCombinedListViewController; @class SBFolderIconImageView; @class SBIconView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBRootFolderController; @class SBIconScrollView; @class SBCoverSheetWindow; @class SBUIProudLockIconView; @class CSScrollView; @class SBHorizontalScrollFailureRecognizer; @class UITouchesEvent; @class SBDockView; @class SBFloatingDockPlatterView; @class _UIPlatterView; @class SBHomeScreenWindow; @class UIWKTextLoupeInteraction; 
