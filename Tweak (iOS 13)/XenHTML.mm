...
@class SBHomeScreenWindow; @class SBIconScrollView; @class CSScrollView; @class SpringBoard; @class CSQuickActionsViewController; @class SBIconListPageControl; @class SBFLockScreenDateView; @class CSCoverSheetView; @class SBMainStatusBarStateProvider; @class SBRootFolderView; @class SBCoverSheetWindow; @class SBMainWorkspace; @class CSFixedFooterView; @class CSTeachableMomentsContainerView; @class SBHomeScreenPreviewView; @class _UIContextMenuActionsListView; @class CSCoverSheetViewController; @class CSPageViewController; @class _UIPlatterView; @class SBScreenWakeAnimationController; @class WKWebView; @class CSMainPageContentViewController; @class XENDashBoardWebViewController; @class SBRootFolderController; @class SBHomeScreenViewController; @class WKContentView; @class SBIconView; @class SBHomeScreenOverlayViewController; @class SBFolderIconImageView; @class SBFloatingDockPlatterView; @class SBHorizontalScrollFailureRecognizer; @class SBBacklightController; @class SBHomeScreenView; @class CSMainPageView; @class SBUIProudLockIconView; @class CSCombinedListViewController; @class SBIdleTimerGlobalStateMonitor; @class SBFluidSwitcherGestureWorkspaceTransaction; @class UITouch; @class UITouchesEvent; @class UIWKTextLoupeInteraction; @class SBDockView; @class SBDashBoardLockScreenEnvironment; @class SBIconListView; @class SBLockScreenManager; 
...
static UIView* _logos_method$SpringBoard$SBRootFolderView$hitTest$withEvent$(_LOGOS_SELF_TYPE_NORMAL SBRootFolderView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, CGPoint point, UIEvent * event) {
    ...
    if ([XENHResources SBEnabled] && [XENHResources SBOnePageWidgetMode]) {
        ...
        XENlog(@"SBRootFolderView hittest %@", originalResult);
...
static __attribute__((constructor)) void _logosLocalCtor_c9a07729(int __unused argc, char __unused **argv, char __unused **envp) {
