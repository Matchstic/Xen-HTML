...
@class UITouchesEvent; @class CSQuickActionsViewController; @class SBMainStatusBarStateProvider; @class SBScreenWakeAnimationController; @class SBIdleTimerDefaults; @class SBFolderIconBackgroundView; @class CSMainPageContentViewController; @class SBIconListPageControl; @class WKWebView; @class SBCoverSheetWindow; @class SBBacklightController; @class CSPageViewController; @class CSFixedFooterView; @class SBRootFolderController; @class SBApplication; @class _UIPlatterView; @class SBLockScreenNotificationListController; @class SBIconScrollView; @class SBUIProudLockIconView; @class UIWKTextLoupeInteraction; @class SBLockScreenManager; @class SBHomeScreenViewController; @class SBDockView; @class SBRootIconListView; @class CSScrollView; @class SBHomeScreenWindow; @class SBHorizontalScrollFailureRecognizer; @class SBFluidSwitcherGestureWorkspaceTransaction; @class XENDashBoardWebViewController; @class SBHomeScreenPreviewView; @class SBFLockScreenDateView; @class SBLockScreenViewController; @class CSTeachableMomentsContainerView; @class SBMainWorkspace; @class SBIconView; @class SBMainSwitcherViewController; @class SpringBoard; @class CSMainPageView; @class UITouch; @class CSCoverSheetViewController; @class CSCoverSheetView; @class CSCombinedListViewController; @class SBFloatingDockPlatterView; @class SBRootFolderView; @class SBHomeScreenView; 
...
static __attribute__((constructor)) void _logosLocalCtor_b2305825(int __unused argc, char __unused **argv, char __unused **envp) {
