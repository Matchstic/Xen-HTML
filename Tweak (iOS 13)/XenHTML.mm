...
@class SBHomeScreenPreviewView; @class SBFolderIconImageView; @class SBHomeScreenWindow; @class SBLockScreenManager; @class SBHomeScreenView; @class SBIconView; @class CSFixedFooterView; @class SBMainStatusBarStateProvider; @class UITouch; @class _UIPlatterView; @class WKWebView; @class SBDockView; @class SBScreenWakeAnimationController; @class CSCoverSheetView; @class SBRootFolderView; @class SBRootFolderController; @class SBBacklightController; @class SBCoverSheetWindow; @class CSMainPageView; @class SBUIProudLockIconView; @class CSCoverSheetViewController; @class UIWKTextLoupeInteraction; @class CSTeachableMomentsContainerView; @class CSScrollView; @class SBHomeScreenViewController; @class CSQuickActionsViewController; @class SBFLockScreenDateView; @class SBHorizontalScrollFailureRecognizer; @class SpringBoard; @class CSCombinedListViewController; @class SBMainWorkspace; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBIconListView; @class CSMainPageContentViewController; @class SBIconScrollView; @class CSPageViewController; @class SBIdleTimerGlobalStateMonitor; @class SBFloatingDockPlatterView; @class UITouchesEvent; @class XENDashBoardWebViewController; @class SBIconListPageControl; 
