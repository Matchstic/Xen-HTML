...
@class CSTeachableMomentsContainerView; @class SBHomeScreenViewController; @class SBIdleTimerGlobalStateMonitor; @class SBHomeScreenPreviewView; @class SBMainWorkspace; @class SBApplication; @class CSQuickActionsViewController; @class SpringBoard; @class SBLockScreenManager; @class SBHomeScreenWindow; @class CSMainPageContentViewController; @class UITouchesEvent; @class SBUIProudLockIconView; @class SBRootFolderView; @class CSMainPageView; @class CSPageViewController; @class _UIPlatterView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBMainSwitcherViewController; @class SBHomeScreenView; @class CSFixedFooterView; @class SBIconListView; @class SBIconListPageControl; @class SBIconView; @class CSCombinedListViewController; @class SBScreenWakeAnimationController; @class UITouch; @class CSScrollView; @class SBHorizontalScrollFailureRecognizer; @class SBDockView; @class XENDashBoardWebViewController; @class SBFloatingDockPlatterView; @class SBFLockScreenDateView; @class SBMainStatusBarStateProvider; @class WKWebView; @class SBIconScrollView; @class CSCoverSheetViewController; @class CSCoverSheetView; @class SBRootFolderController; @class XIAlarms; @class SBBacklightController; @class SBFolderIconImageView; @class UIWKTextLoupeInteraction; @class SBCoverSheetWindow; 
...
static void (*_logos_orig$XenInfoLegacy$XIAlarms$requestRefresh)(_LOGOS_SELF_TYPE_NORMAL XIAlarms* _LOGOS_SELF_CONST, SEL); static void _logos_method$XenInfoLegacy$XIAlarms$requestRefresh(_LOGOS_SELF_TYPE_NORMAL XIAlarms* _LOGOS_SELF_CONST, SEL); 



static void _logos_method$XenInfoLegacy$XIAlarms$requestRefresh(_LOGOS_SELF_TYPE_NORMAL XIAlarms* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
...
static __attribute__((constructor)) void _logosLocalCtor_c3e2db95(int __unused argc, char __unused **argv, char __unused **envp) {
    ...
    if (sb) {
        ...
        {Class _logos_class$XenInfoLegacy$XIAlarms = objc_getClass("XIAlarms"); MSHookMessageEx(_logos_class$XenInfoLegacy$XIAlarms, @selector(requestRefresh), (IMP)&_logos_method$XenInfoLegacy$XIAlarms$requestRefresh, (IMP*)&_logos_orig$XenInfoLegacy$XIAlarms$requestRefresh);}
