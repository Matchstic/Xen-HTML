...
@class CSScrollView; @class SBHomeScreenWindow; @class CSMainPageView; @class SBFolderIconImageView; @class SBBacklightController; @class SBFLockScreenDateView; @class SBFloatingDockPlatterView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class CSPageViewController; @class SBScreenWakeAnimationController; @class SBIconListView; @class CSFixedFooterView; @class CSQuickActionsViewController; @class SBIconListPageControl; @class SBIconView; @class SBLockScreenManager; @class SBIconScrollView; @class WKWebView; @class SBMainStatusBarStateProvider; @class SBHomeScreenPreviewView; @class CSCoverSheetView; @class SBHorizontalScrollFailureRecognizer; @class SBDockView; @class CSMainPageContentViewController; @class CSTeachableMomentsContainerView; @class SBRootFolderView; @class UITouch; @class CSCoverSheetViewController; @class SBMainWorkspace; @class XENDashBoardWebViewController; @class SpringBoard; @class UIWKTextLoupeInteraction; @class SBIdleTimerGlobalStateMonitor; @class SBRootFolderController; @class SBUIProudLockIconView; @class SBHomeScreenViewController; @class _UIPlatterView; @class CSCombinedListViewController; @class UITouchesEvent; @class SBHomeScreenView; @class SBCoverSheetWindow; 
