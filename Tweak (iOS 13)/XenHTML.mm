...
@class XENDashBoardWebViewController; @class SBMainStatusBarStateProvider; @class SBRootFolderView; @class SBIconScrollView; @class CSQuickActionsViewController; @class SBHomeScreenPreviewView; @class SBFloatingDockPlatterView; @class SBIdleTimerGlobalStateMonitor; @class SBDockView; @class SBBacklightController; @class CSTeachableMomentsContainerView; @class CSCoverSheetViewController; @class SBFLockScreenDateView; @class CSCoverSheetView; @class SBScreenWakeAnimationController; @class CSMainPageView; @class CSScrollView; @class SBIconListView; @class SBRootFolderController; @class SBUIProudLockIconView; @class SBIconListPageControl; @class SBFluidSwitcherGestureWorkspaceTransaction; @class CSCombinedListViewController; @class SBFolderIconImageView; @class _UIPlatterView; @class CSMainPageContentViewController; @class UITouchesEvent; @class SBHomeScreenView; @class UIWKTextLoupeInteraction; @class SBLockScreenManager; @class SBHomeScreenViewController; @class SBCoverSheetWindow; @class WKWebView; @class UITouch; @class SBHorizontalScrollFailureRecognizer; @class SpringBoard; @class SBIconView; @class SBMainWorkspace; @class CSPageViewController; @class SBHomeScreenWindow; @class CSFixedFooterView; 
