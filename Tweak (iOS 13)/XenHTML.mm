...
@class CSScrollView; @class CSCoverSheetView; @class SBCoverSheetWindow; @class SBHomeScreenPreviewView; @class CSTeachableMomentsContainerView; @class CSPageViewController; @class SBIconView; @class SBRootFolderView; @class SBFLockScreenDateView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBFloatingDockPlatterView; @class SBIconScrollView; @class SBHorizontalScrollFailureRecognizer; @class XENDashBoardWebViewController; @class SpringBoard; @class SBIconListPageControl; @class CSFixedFooterView; @class SBHomeScreenViewController; @class SBFolderIconImageView; @class SBDockView; @class CSMainPageContentViewController; @class SBBacklightController; @class WKWebView; @class UIWKTextLoupeInteraction; @class UITouchesEvent; @class _UIPlatterView; @class SBMainStatusBarStateProvider; @class UITouch; @class SBLockScreenManager; @class SBIconListView; @class SBHomeScreenWindow; @class CSCoverSheetViewController; @class SBIdleTimerGlobalStateMonitor; @class CSMainPageView; @class SBScreenWakeAnimationController; @class SBRootFolderController; @class SBHomeScreenView; @class SBUIProudLockIconView; @class SBMainWorkspace; @class CSQuickActionsViewController; @class CSCombinedListViewController; 
