...
@class SBRootFolderView; @class SBBacklightController; @class SBHomeScreenPreviewView; @class CSScrollView; @class CSCoverSheetView; @class SBIdleTimerGlobalStateMonitor; @class UITouch; @class SBIconListView; @class SBFloatingDockPlatterView; @class SBIconView; @class SBFLockScreenDateView; @class UITouchesEvent; @class CSMainPageView; @class CSPageViewController; @class CSTeachableMomentsContainerView; @class WKWebView; @class SpringBoard; @class SBHomeScreenWindow; @class SBHomeScreenViewController; @class _UIPlatterView; @class SBScreenWakeAnimationController; @class SBUIProudLockIconView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class CSCombinedListViewController; @class XENDashBoardWebViewController; @class SBMainWorkspace; @class CSCoverSheetViewController; @class SBCoverSheetWindow; @class CSFixedFooterView; @class CSQuickActionsViewController; @class SBIconListPageControl; @class SBRootFolderController; @class UIWKTextLoupeInteraction; @class SBIconScrollView; @class SBHorizontalScrollFailureRecognizer; @class SBLockScreenManager; @class SBMainStatusBarStateProvider; @class SBFolderIconImageView; @class SBDockView; @class SBHomeScreenView; @class CSMainPageContentViewController; 
