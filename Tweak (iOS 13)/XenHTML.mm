...
@class CSFixedFooterView; @class SBFolderIconImageView; @class XENDashBoardWebViewController; @class SpringBoard; @class SBUIProudLockIconView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBHomeScreenPreviewView; @class UITouch; @class SBHorizontalScrollFailureRecognizer; @class SBHomeScreenViewController; @class SBScreenWakeAnimationController; @class SBCoverSheetWindow; @class CSCoverSheetViewController; @class SBIdleTimerGlobalStateMonitor; @class UIWKTextLoupeInteraction; @class _UIPlatterView; @class SBIconListPageControl; @class WKContentView; @class SBIconScrollView; @class SBBacklightController; @class SBRootFolderController; @class SBFloatingDockPlatterView; @class CSScrollView; @class SBMainStatusBarStateProvider; @class CSMainPageContentViewController; @class SBIconView; @class SBHomeScreenWindow; @class SBRootFolderView; @class SBDockView; @class CSCoverSheetView; @class CSMainPageView; @class SBMainWorkspace; @class SBHomeScreenView; @class SBLockScreenManager; @class CSTeachableMomentsContainerView; @class SBIconListView; @class WKWebView; @class CSQuickActionsViewController; @class CSCombinedListViewController; @class UITouchesEvent; @class SBFLockScreenDateView; @class CSPageViewController; 
static BOOL (*_logos_orig$_ungrouped$WKContentView$gestureRecognizerShouldBegin$)(_LOGOS_SELF_TYPE_NORMAL WKContentView* _LOGOS_SELF_CONST, SEL, UIGestureRecognizer *); static BOOL _logos_method$_ungrouped$WKContentView$gestureRecognizerShouldBegin$(_LOGOS_SELF_TYPE_NORMAL WKContentView* _LOGOS_SELF_CONST, SEL, UIGestureRecognizer *); 
...
static BOOL _logos_method$_ungrouped$WKContentView$gestureRecognizerShouldBegin$(_LOGOS_SELF_TYPE_NORMAL WKContentView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, UIGestureRecognizer * gestureRecognizer) {
    ...
    return _logos_orig$_ungrouped$WKContentView$gestureRecognizerShouldBegin$(self, _cmd, gestureRecognizer);
}
...
static __attribute__((constructor)) void _logosLocalCtor_45c4f9f1(int __unused argc, char __unused **argv, char __unused **envp) {
    ...
    {Class _logos_class$_ungrouped$WKContentView = objc_getClass("WKContentView"); MSHookMessageEx(_logos_class$_ungrouped$WKContentView, @selector(gestureRecognizerShouldBegin:), (IMP)&_logos_method$_ungrouped$WKContentView$gestureRecognizerShouldBegin$, (IMP*)&_logos_orig$_ungrouped$WKContentView$gestureRecognizerShouldBegin$); MSHookFunction((void *)MSFindSymbol(NULL, "__ZNK6WebKit45WebDeviceOrientationAndMotionAccessController33cachedDeviceOrientationPermissionERKN7WebCore18SecurityOriginDataE"), (void *)&_logos_function$_ungrouped$lookup$__ZNK6WebKit45WebDeviceOrientationAndMotionAccessController33cachedDeviceOrientationPermissionERKN7WebCore18SecurityOriginDataE, (void **)&_logos_orig$_ungrouped$lookup$__ZNK6WebKit45WebDeviceOrientationAndMotionAccessController33cachedDeviceOrientationPermissionERKN7WebCore18SecurityOriginDataE);}
