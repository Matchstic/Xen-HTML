...
@class SBCoverSheetWindow; @class SBLockScreenManager; @class SBRootFolderController; @class SBIconListPageControl; @class CSFixedFooterView; @class SBHomeScreenViewController; @class SBScreenWakeAnimationController; @class SBMainWorkspace; @class WKWebView; @class SBIconView; @class SBHomeScreenPreviewView; @class UITouch; @class UITouchesEvent; @class SBIdleTimerGlobalStateMonitor; @class CSCoverSheetView; @class SBMainStatusBarStateProvider; @class SBFluidSwitcherGestureWorkspaceTransaction; @class CSQuickActionsViewController; @class SBUIProudLockIconView; @class CSCoverSheetViewController; @class CSTeachableMomentsContainerView; @class SBFloatingDockPlatterView; @class SBHomeScreenView; @class CSScrollView; @class SBFolderIconImageView; @class SBIconScrollView; @class CSPageViewController; @class SBIconListView; @class CSCombinedListViewController; @class _UIPlatterView; @class SBHomeScreenWindow; @class XENDashBoardWebViewController; @class UIWKTextLoupeInteraction; @class SBBacklightController; @class SBRootFolderView; @class CSMainPageContentViewController; @class SBFLockScreenDateView; @class SpringBoard; @class CSMainPageView; @class SBHorizontalScrollFailureRecognizer; @class SBDockView; 
