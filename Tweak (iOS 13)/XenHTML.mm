...
@class CSPageViewController; @class SBIconView; @class _UIPlatterView; @class CSCoverSheetViewController; @class SpringBoard; @class CSScrollView; @class _UIContextMenuActionsListView; @class SBIconListPageControl; @class UITouchesEvent; @class WKWebView; @class SBRootFolderView; @class SBIdleTimerGlobalStateMonitor; @class SBLockScreenManager; @class SBFLockScreenDateView; @class SBCoverSheetWindow; @class SBHomeScreenOverlayViewController; @class CSCoverSheetView; @class XENDashBoardWebViewController; @class CSCombinedListViewController; @class SBHomeScreenWindow; @class SBMainStatusBarStateProvider; @class CSMainPageView; @class CSQuickActionsViewController; @class WKContentView; @class SBFloatingDockPlatterView; @class CSTeachableMomentsContainerView; @class SBIconScrollView; @class SBHomeScreenView; @class SBHomeScreenViewController; @class SBFolderIconImageView; @class SBUIProudLockIconView; @class UITouch; @class CSFixedFooterView; @class SBHorizontalScrollFailureRecognizer; @class SBRootFolderController; @class SBBacklightController; @class SBIconListView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBDockView; @class SBMainWorkspace; @class UIWKTextLoupeInteraction; @class SBHomeScreenPreviewView; @class SBScreenWakeAnimationController; @class CSMainPageContentViewController; @class SBDashBoardLockScreenEnvironment; 
