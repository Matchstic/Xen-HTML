...
@class CSCoverSheetView; @class SBMainSwitcherViewController; @class SBRootFolderView; @class CSCombinedListViewController; @class UITouchesEvent; @class SBIconScrollView; @class CSScrollView; @class CSTeachableMomentsContainerView; @class SBIconListPageControl; @class WKWebView; @class SBHomeScreenWindow; @class SBHomeScreenPreviewView; @class SBRootFolderController; @class SBHorizontalScrollFailureRecognizer; @class CSPageViewController; @class SBFolderIconBackgroundView; @class CSMainPageContentViewController; @class SBIconView; @class XENDashBoardWebViewController; @class UITouch; @class SBMainWorkspace; @class SBCoverSheetWindow; @class SBFloatingDockPlatterView; @class SBFLockScreenDateView; @class SBIdleTimerDefaults; @class _UIPlatterView; @class SBDockView; @class SBBacklightController; @class CSFixedFooterView; @class SBMainStatusBarStateProvider; @class SBIdleTimerGlobalStateMonitor; @class CSQuickActionsViewController; @class SBLockScreenManager; @class SpringBoard; @class CSCoverSheetViewController; @class SBApplication; @class SBHomeScreenView; @class SBIconListView; @class SBScreenWakeAnimationController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBHomeScreenViewController; @class UIWKTextLoupeInteraction; @class SBUIProudLockIconView; @class CSMainPageView; 
...
static void _logos_method$SpringBoard$SBIdleTimerDefaults$_bindAndRegisterDefaults(_LOGOS_SELF_TYPE_NORMAL SBIdleTimerDefaults* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    ...
    XENlog(@"_bindAndRegisterDefaults");
...
static CGFloat _logos_method$SpringBoard$SBIdleTimerDefaults$_xenhtml_minimumLockscreenIdleTime(_LOGOS_SELF_TYPE_NORMAL SBIdleTimerDefaults* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    ...
    XENlog(@"_xenhtml_minimumLockscreenIdleTime, %@", [NSThread callStackSymbols]);
    ...
    return [self _xenhtml_minimumLockscreenIdleTime];
}
...
static CGFloat _logos_method$SpringBoard$SBIdleTimerGlobalStateMonitor$minimumLockscreenIdleTime(_LOGOS_SELF_TYPE_NORMAL SBIdleTimerGlobalStateMonitor* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    XENlog(@"SBIdleTimerGlobalStateMonitor minimumLockscreenIdleTime");
