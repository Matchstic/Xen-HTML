...
@class SBScreenWakeAnimationController; @class SBFLockScreenMetrics; @class UIWebView; @class SBUICallToActionLabel; @class SBDashBoardTeachableMomentsContainerView; @class SBLockScreenViewController; @class SBRootFolderView; @class SBAlertWindow; @class SBHomeScreenViewController; @class SBCoverSheetWindow; @class SBBacklightController; @class SBPagedScrollView; @class SBManualIdleTimer; @class SBDockView; @class _NowPlayingArtView; @class SBIconView; @class PHContainerView; @class XENResources; @class XENDashBoardWebViewController; @class SBLockScreenNotificationListController; @class SBDashBoardView; @class SBFolderIconBackgroundView; @class SBApplication; @class XENNotificationsCollectionViewController; @class SBLockScreenBounceAnimator; @class SBFloatingDockPlatterView; @class SBDashBoardFixedFooterView; @class SBDashBoardNotificationListViewController; @class SBHomeScreenView; @class SBFLockScreenDateView; @class SBDashBoardMainPageContentViewController; @class SBIdleTimerDefaults; @class SBLockScreenNotificationListView; @class SBDashBoardMediaArtworkViewController; @class SpringBoard; @class UITouch; @class SBDashBoardPageViewController; @class SBMainSwitcherViewController; @class SBLockScreenManager; @class SBUIController; @class UITouchesEvent; @class SBDashBoardCombinedListViewController; @class SBDashBoardQuickActionsViewController; @class SBDashBoardNotificationAdjunctListViewController; @class WKWebView; @class SBUIProudLockIconView; @class SBHorizontalScrollFailureRecognizer; @class SBMainStatusBarStateProvider; @class SBLockScreenView; @class SBMainWorkspace; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBDashBoardMainPageViewController; @class SBDashBoardViewController; @class SBDashBoardMainPageView; 
...
static __attribute__((constructor)) void _logosLocalCtor_a308c7ac(int __unused argc, char __unused **argv, char __unused **envp) {
