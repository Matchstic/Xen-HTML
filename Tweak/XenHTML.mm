...
@class SBLockScreenView; @class SBFolderIconBackgroundView; @class XENResources; @class SBApplication; @class SpringBoard; @class SBLockScreenNotificationListController; @class SBIdleTimerDefaults; @class SBRootFolderView; @class SBDashBoardCombinedListViewController; @class SBDashBoardMediaArtworkViewController; @class SBDashBoardViewController; @class SBMainWorkspace; @class SBIconView; @class SBPagedScrollView; @class SBDashBoardMainPageViewController; @class UIWebView; @class SBMainSwitcherViewController; @class SBMainStatusBarStateProvider; @class SBManualIdleTimer; @class SBHorizontalScrollFailureRecognizer; @class _NowPlayingArtView; @class SBHomeScreenView; @class SBDashBoardTeachableMomentsContainerView; @class SBDashBoardQuickActionsViewController; @class XENDashBoardWebViewController; @class SBDashBoardPageViewController; @class SBDashBoardNotificationAdjunctListViewController; @class SBLockScreenBounceAnimator; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBDashBoardView; @class UITouchesEvent; @class SBScreenWakeAnimationController; @class SBDashBoardMainPageContentViewController; @class SBLockScreenManager; @class SBUIProudLockIconView; @class SBUICallToActionLabel; @class SBLockScreenNotificationListView; @class WKWebView; @class SBHomeScreenViewController; @class SBCoverSheetWindow; @class SBBacklightController; @class SBDashBoardFixedFooterView; @class PHContainerView; @class SBLockScreenViewController; @class SBFLockScreenDateView; @class XENNotificationsCollectionViewController; @class SBUIController; @class SBFloatingDockPlatterView; @class SBFLockScreenMetrics; @class SBDashBoardMainPageView; @class SBAlertWindow; @class SBDashBoardNotificationListViewController; @class SBDockView; 
