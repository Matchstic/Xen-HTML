...
@class XENResources; @class SBPagedScrollView; @class SBFolderIconBackgroundView; @class SBHomeScreenView; @class SBUICallToActionLabel; @class UIWebView; @class SBBacklightController; @class SBMainSwitcherViewController; @class SBDashBoardViewController; @class SpringBoard; @class UITouchesEvent; @class SBMainWorkspace; @class SBDashBoardPageViewController; @class SBDashBoardView; @class SBFLockScreenDateView; @class SBDashBoardNotificationAdjunctListViewController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBManualIdleTimer; @class SBUIProudLockIconView; @class SBLockScreenManager; @class SBDashBoardNotificationListViewController; @class SBApplication; @class SBRootFolderView; @class XENNotificationsCollectionViewController; @class SBLockScreenView; @class SBLockScreenBounceAnimator; @class SBDashBoardFixedFooterView; @class _NowPlayingArtView; @class SBFLockScreenMetrics; @class SBScreenWakeAnimationController; @class SBCoverSheetWindow; @class SBMainStatusBarStateProvider; @class SBIconView; @class SBAlertWindow; @class SBFloatingDockPlatterView; @class SBLockScreenViewController; @class SBDashBoardMediaArtworkViewController; @class SBLockScreenNotificationListView; @class SBDashBoardMainPageContentViewController; @class SBHorizontalScrollFailureRecognizer; @class SBHomeScreenViewController; @class WKWebView; @class SBDashBoardQuickActionsViewController; @class XENDashBoardWebViewController; @class SBLockScreenNotificationListController; @class SBDashBoardTeachableMomentsContainerView; @class SBUIController; @class SBDashBoardCombinedListViewController; @class SBDashBoardMainPageViewController; @class PHContainerView; @class SBIdleTimerDefaults; @class SBDashBoardMainPageView; @class SBDockView; 
