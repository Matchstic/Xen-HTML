...
@class SBDashBoardMediaArtworkViewController; @class SBDashBoardViewController; @class SBMainWorkspace; @class SBLockScreenManager; @class SBDockView; @class WKWebView; @class SBHomeScreenViewController; @class SBIconView; @class UIWebView; @class SBBacklightController; @class SBDashBoardNotificationAdjunctListViewController; @class PHContainerView; @class SBDashBoardNotificationListViewController; @class SBHomeScreenView; @class SBAlertWindow; @class UITouchesEvent; @class XENResources; @class SBDashBoardPageViewController; @class SBLockScreenView; @class SBMainStatusBarStateProvider; @class SBFLockScreenMetrics; @class SBDashBoardMainPageContentViewController; @class SBFLockScreenDateView; @class SBRootFolderView; @class _NowPlayingArtView; @class SBLockScreenBounceAnimator; @class SBFloatingDockPlatterView; @class SBUIController; @class SBIdleTimerDefaults; @class SBDashBoardView; @class SBLockScreenNotificationListController; @class SBFolderIconBackgroundView; @class SpringBoard; @class SBDashBoardMainPageView; @class XENNotificationsCollectionViewController; @class SBDashBoardQuickActionsViewController; @class SBDashBoardMainPageViewController; @class SBMainSwitcherViewController; @class SBDashBoardTeachableMomentsContainerView; @class SBPagedScrollView; @class SBLockScreenViewController; @class XENDashBoardWebViewController; @class SBDashBoardFixedFooterView; @class SBManualIdleTimer; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBScreenWakeAnimationController; @class SBUIProudLockIconView; @class SBLockScreenNotificationListView; @class SBDashBoardCombinedListViewController; @class SBApplication; @class SBCoverSheetWindow; @class SBHorizontalScrollFailureRecognizer; @class SBUICallToActionLabel; 
