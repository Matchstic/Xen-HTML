...
@class SBScreenWakeAnimationController; @class WKWebView; @class SBLockScreenViewController; @class SBFolderIconBackgroundView; @class SBMainStatusBarStateProvider; @class SBUIController; @class SBAlertWindow; @class SBUIProudLockIconView; @class SBDashBoardView; @class XENNotificationsCollectionViewController; @class SBDashBoardCombinedListViewController; @class SBDockView; @class SBDashBoardQuickActionsViewController; @class SBDashBoardMainPageContentViewController; @class PHContainerView; @class SBIdleTimerDefaults; @class XENDashBoardWebViewController; @class SBFLockScreenMetrics; @class SBFloatingDockPlatterView; @class SBHomeScreenView; @class SBHomeScreenViewController; @class SBApplication; @class SBFLockScreenDateView; @class _NowPlayingArtView; @class SBPagedScrollView; @class SBRootFolderView; @class SBMainSwitcherViewController; @class SBDashBoardNotificationAdjunctListViewController; @class SBDashBoardMainPageViewController; @class SBCoverSheetWindow; @class SBLockScreenNotificationListController; @class SBDashBoardFixedFooterView; @class SBIconView; @class UITouchesEvent; @class SBLockScreenBounceAnimator; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBMainWorkspace; @class SBBacklightController; @class SBDashBoardTeachableMomentsContainerView; @class SBLockScreenNotificationListView; @class XENResources; @class SBLockScreenManager; @class SBDashBoardViewController; @class SBUICallToActionLabel; @class SBDashBoardMainPageView; @class SBDashBoardPageViewController; @class SpringBoard; @class SBManualIdleTimer; @class SBDashBoardMediaArtworkViewController; @class SBDashBoardNotificationListViewController; @class SBLockScreenView; @class UIWebView; @class SBHorizontalScrollFailureRecognizer; 
