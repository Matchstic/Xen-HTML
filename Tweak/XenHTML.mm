...
@class XENDashBoardWebViewController; @class SBMainWorkspace; @class UIWebView; @class SBUICallToActionLabel; @class SBDashBoardQuickActionsViewController; @class XENResources; @class SBHorizontalScrollFailureRecognizer; @class SBFLockScreenDateView; @class SBAlertWindow; @class UITouchesEvent; @class SBDashBoardView; @class SBScreenWakeAnimationController; @class SBLockScreenManager; @class SBDashBoardMediaArtworkViewController; @class SBLockScreenViewController; @class SBLockScreenNotificationListController; @class SBCoverSheetWindow; @class SBRootFolderView; @class WKWebView; @class SBBacklightController; @class SBApplication; @class SBDashBoardMainPageContentViewController; @class SBDashBoardNotificationAdjunctListViewController; @class SBLockScreenView; @class SBLockScreenNotificationListView; @class SBDashBoardCombinedListViewController; @class SBPagedScrollView; @class SBFLockScreenMetrics; @class SpringBoard; @class SBFolderIconBackgroundView; @class SBHomeScreenView; @class SBHomeScreenViewController; @class PHContainerView; @class SBDockView; @class SBUIController; @class SBMainSwitcherViewController; @class SBIdleTimerDefaults; @class XENNotificationsCollectionViewController; @class SBDashBoardMainPageView; @class SBUIProudLockIconView; @class SBDashBoardTeachableMomentsContainerView; @class SBFloatingDockPlatterView; @class _NowPlayingArtView; @class SBLockScreenBounceAnimator; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBManualIdleTimer; @class SBDashBoardViewController; @class SBIconView; @class SBDashBoardMainPageViewController; @class SBMainStatusBarStateProvider; @class SBDashBoardPageViewController; @class SBDashBoardFixedFooterView; @class SBDashBoardNotificationListViewController; 
