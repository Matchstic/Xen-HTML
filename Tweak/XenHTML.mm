...
@class WKWebView; @class _NowPlayingArtView; @class SBDashBoardPageViewController; @class SBBacklightController; @class SBMainSwitcherViewController; @class SBMainWorkspace; @class SBScreenWakeAnimationController; @class SBDashBoardTeachableMomentsContainerView; @class SBUICallToActionLabel; @class SBAlertWindow; @class SBFLockScreenMetrics; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBDashBoardView; @class UIWebView; @class SBDockView; @class SBRootFolderController; @class SBHorizontalScrollFailureRecognizer; @class XENNotificationsCollectionViewController; @class XENResources; @class SBDashBoardMainPageView; @class SBIconScrollView; @class UITouch; @class SpringBoard; @class SBLockScreenBounceAnimator; @class SBRootFolderView; @class SBDashBoardMediaArtworkViewController; @class SBDashBoardQuickActionsViewController; @class SBFolderIconBackgroundView; @class UITouchesEvent; @class SBDashBoardMainPageContentViewController; @class SBLockScreenNotificationListController; @class SBApplication; @class SBFLockScreenDateView; @class SBFloatingDockPlatterView; @class SBIdleTimerDefaults; @class SBDashBoardNotificationListViewController; @class SBLockScreenView; @class SBCoverSheetWindow; @class SBDashBoardFixedFooterView; @class SBMainStatusBarStateProvider; @class XENDashBoardWebViewController; @class SBDashBoardViewController; @class SBPagedScrollView; @class SBLockScreenNotificationListView; @class SBHomeScreenViewController; @class SBUIProudLockIconView; @class SBDashBoardMainPageViewController; @class SBIconView; @class SBHomeScreenView; @class SBManualIdleTimer; @class SBUIController; @class SBLockScreenViewController; @class SBDashBoardCombinedListViewController; @class PHContainerView; @class SBDashBoardNotificationAdjunctListViewController; @class SBLockScreenManager; 
...
static __attribute__((constructor)) void _logosLocalCtor_abf4ae62(int __unused argc, char __unused **argv, char __unused **envp) {
