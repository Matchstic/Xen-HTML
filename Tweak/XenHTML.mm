...
@class WKWebView; @class SBFLockScreenDateView; @class SBManualIdleTimer; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBLockScreenManager; @class SBIconView; @class SBMainSwitcherViewController; @class SBLockScreenBounceAnimator; @class SBLockScreenNotificationListView; @class SBScreenWakeAnimationController; @class SBDockView; @class SBDashBoardMainPageView; @class PHContainerView; @class SBApplication; @class UIWebView; @class SBMainStatusBarStateProvider; @class SBDashBoardNotificationAdjunctListViewController; @class XENNotificationsCollectionViewController; @class SBLockScreenView; @class XENResources; @class SBBacklightController; @class SBLockScreenViewController; @class SBDashBoardMainPageContentViewController; @class SBHomeScreenView; @class SBUIController; @class UITouchesEvent; @class SBDashBoardMediaArtworkViewController; @class SBHorizontalScrollFailureRecognizer; @class _NowPlayingArtView; @class SBFloatingDockPlatterView; @class SBUIProudLockIconView; @class SpringBoard; @class SBRootFolderView; @class SBDashBoardMainPageViewController; @class SBCoverSheetWindow; @class SBPagedScrollView; @class SBUICallToActionLabel; @class XENDashBoardWebViewController; @class SBFLockScreenMetrics; @class SBMainWorkspace; @class SBLockScreenNotificationListController; @class SBAlertWindow; @class SBDashBoardViewController; @class SBDashBoardNotificationListViewController; @class SBDashBoardQuickActionsViewController; @class SBDashBoardCombinedListViewController; @class SBDashBoardTeachableMomentsContainerView; @class SBDashBoardPageViewController; @class SBIdleTimerDefaults; @class SBFolderIconBackgroundView; @class SBDashBoardFixedFooterView; @class SBDashBoardView; @class SBHomeScreenViewController; 
...
static __attribute__((constructor)) void _logosLocalCtor_e58b2fc2(int __unused argc, char __unused **argv, char __unused **envp) {
    {}
