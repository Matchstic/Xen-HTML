...
@class SBDashBoardViewController; @class SBDashBoardTeachableMomentsContainerView; @class SBDashBoardQuickActionsViewController; @class UIWebView; @class SBApplication; @class SBDashBoardView; @class XENDashBoardWebViewController; @class SBLockScreenView; @class SBDashBoardMainPageView; @class WKWebView; @class SBFolderIconBackgroundView; @class SBDashBoardNotificationListViewController; @class SBLockScreenNotificationListView; @class SBHomeScreenViewController; @class SBUIProudLockIconView; @class SBMainWorkspace; @class PHContainerView; @class SBDashBoardMediaArtworkViewController; @class SBDashBoardPageViewController; @class SBLockScreenViewController; @class SBDashBoardCombinedListViewController; @class SBUICallToActionLabel; @class XENResources; @class SBCoverSheetWindow; @class SBScreenWakeAnimationController; @class SBIdleTimerDefaults; @class SBBacklightController; @class SBLockScreenNotificationListController; @class SBLockScreenBounceAnimator; @class SBAlertWindow; @class SBFLockScreenDateView; @class SBPagedScrollView; @class SBFloatingDockPlatterView; @class SBDashBoardFixedFooterView; @class SBDashBoardNotificationAdjunctListViewController; @class SBFLockScreenMetrics; @class _NowPlayingArtView; @class SBLockScreenManager; @class UITouchesEvent; @class SBRootFolderView; @class SBUIController; @class SBDashBoardMainPageViewController; @class SBIconView; @class SBMainStatusBarStateProvider; @class SBDockView; @class XENNotificationsCollectionViewController; @class SBDashBoardMainPageContentViewController; @class SBMainSwitcherViewController; @class SBHorizontalScrollFailureRecognizer; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBManualIdleTimer; @class SpringBoard; @class SBHomeScreenView; 
