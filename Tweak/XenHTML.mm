...
@class SBLockScreenManager; @class SBDashBoardFixedFooterView; @class SBIdleTimerDefaults; @class SBDockView; @class SBMainSwitcherViewController; @class SBAlertWindow; @class SBLockScreenNotificationListController; @class SBMainWorkspace; @class SBApplication; @class SBUIController; @class SBIconView; @class XENDashBoardWebViewController; @class SBManualIdleTimer; @class SBDashBoardView; @class SBFloatingDockPlatterView; @class SBDashBoardMainPageViewController; @class SBDashBoardCombinedListViewController; @class SBMainStatusBarStateProvider; @class SBFolderIconBackgroundView; @class SBUICallToActionLabel; @class SpringBoard; @class SBDashBoardNotificationAdjunctListViewController; @class SBUIProudLockIconView; @class SBDashBoardMainPageView; @class UIWebView; @class SBDashBoardNotificationListViewController; @class SBDashBoardViewController; @class PHContainerView; @class SBDashBoardMediaArtworkViewController; @class SBHomeScreenView; @class SBBacklightController; @class SBScreenWakeAnimationController; @class SBRootFolderView; @class SBHomeScreenViewController; @class SBPagedScrollView; @class XENNotificationsCollectionViewController; @class SBLockScreenBounceAnimator; @class _NowPlayingArtView; @class SBDashBoardPageViewController; @class SBDashBoardQuickActionsViewController; @class XENResources; @class SBDashBoardMainPageContentViewController; @class SBDashBoardTeachableMomentsContainerView; @class SBLockScreenView; @class WKWebView; @class UITouchesEvent; @class SBHorizontalScrollFailureRecognizer; @class SBLockScreenViewController; @class SBFLockScreenMetrics; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBCoverSheetWindow; @class SBFLockScreenDateView; @class SBLockScreenNotificationListView; 


#line 307 "/Users/matt/iOS/Projects/Xen-HTML/Tweak/XenHTML.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_fb266409(int __unused argc, char __unused **argv, char __unused **envp) {
    {}
