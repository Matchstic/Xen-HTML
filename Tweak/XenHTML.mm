...
@class SBScreenWakeAnimationController; @class SBHorizontalScrollFailureRecognizer; @class SBFLockScreenMetrics; @class SBApplication; @class WKWebView; @class SBMainWorkspace; @class SBDashBoardTeachableMomentsContainerView; @class UIWebView; @class SBLockScreenViewController; @class SBDashBoardNotificationAdjunctListViewController; @class SBCoverSheetWindow; @class SBMainSwitcherViewController; @class SBIconView; @class XENDashBoardWebViewController; @class SBDashBoardMediaArtworkViewController; @class SBBacklightController; @class SBDashBoardMainPageView; @class SBDockView; @class SBDashBoardViewController; @class _NowPlayingArtView; @class SBRootFolderView; @class SBFolderIconBackgroundView; @class SBPagedScrollView; @class SBDashBoardPageViewController; @class SBLockScreenView; @class SBLockScreenNotificationListController; @class SBDashBoardMainPageViewController; @class SBDashBoardCombinedListViewController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBAlertWindow; @class SBHomeScreenView; @class SBIdleTimerDefaults; @class SBLockScreenBounceAnimator; @class SBLockScreenManager; @class SBDashBoardMainPageContentViewController; @class SBFLockScreenDateView; @class XENNotificationsCollectionViewController; @class SBUIController; @class XENResources; @class SBUICallToActionLabel; @class SBMainStatusBarStateProvider; @class SpringBoard; @class UITouchesEvent; @class PHContainerView; @class SBFloatingDockPlatterView; @class SBDashBoardQuickActionsViewController; @class SBDashBoardView; @class SBManualIdleTimer; @class SBDashBoardNotificationListViewController; @class SBHomeScreenViewController; @class SBDashBoardFixedFooterView; @class SBLockScreenNotificationListView; @class SBUIProudLockIconView; 
...
static __attribute__((constructor)) void _logosLocalCtor_972ba370(int __unused argc, char __unused **argv, char __unused **envp) {
    {}
