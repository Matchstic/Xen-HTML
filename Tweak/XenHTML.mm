...
@class SBLockScreenNotificationListView; @class SBLockScreenNotificationListController; @class SBLockScreenView; @class SBDashBoardMainPageContentViewController; @class SBFloatingDockPlatterView; @class SBUIController; @class SBDashBoardViewController; @class SBDashBoardQuickActionsViewController; @class SBFolderIconBackgroundView; @class SBHorizontalScrollFailureRecognizer; @class SBDashBoardPageViewController; @class SBDashBoardMainPageView; @class WKWebView; @class SBLockScreenManager; @class SBPagedScrollView; @class SBHomeScreenViewController; @class SBIdleTimerDefaults; @class SBFLockScreenDateView; @class SBManualIdleTimer; @class SBLockScreenBounceAnimator; @class SBMainSwitcherViewController; @class SBHomeScreenView; @class SBCoverSheetWindow; @class SBDashBoardCombinedListViewController; @class SBAlertWindow; @class SBLockScreenViewController; @class SBDashBoardNotificationListViewController; @class UITouchesEvent; @class SBRootFolderView; @class SBDashBoardNotificationAdjunctListViewController; @class SBIconView; @class PHContainerView; @class SBMainStatusBarStateProvider; @class SpringBoard; @class XENDashBoardWebViewController; @class SBDashBoardView; @class SBScreenWakeAnimationController; @class SBUIProudLockIconView; @class SBDashBoardMediaArtworkViewController; @class SBBacklightController; @class SBDashBoardTeachableMomentsContainerView; @class SBFLockScreenMetrics; @class SBMainWorkspace; @class _NowPlayingArtView; @class XENResources; @class SBDashBoardFixedFooterView; @class UIWebView; @class SBDashBoardMainPageViewController; @class SBUICallToActionLabel; @class XENNotificationsCollectionViewController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBApplication; @class SBDockView; 
