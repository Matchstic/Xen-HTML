...
static void _logos_method$SpringBoard$SBHomeScreenViewController$_xenhtml_handleDidTap$(_LOGOS_SELF_TYPE_NORMAL SBHomeScreenViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, XENHTapGestureRecognizer* sender) {
    if (!sbhtmlViewController) {
        return; 
    }
...
static __attribute__((constructor)) void _logosLocalCtor_89bdd982(int __unused argc, char __unused **argv, char __unused **envp) {
    {}
