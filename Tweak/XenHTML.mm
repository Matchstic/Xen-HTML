...
@class XENResources; @class SpringBoard; @class SBUICallToActionLabel; @class SBLockScreenView; @class SBLockScreenManager; @class SBLockScreenBounceAnimator; @class SBDashBoardPageViewController; @class SBDashBoardTeachableMomentsContainerView; @class SBDashBoardCombinedListViewController; @class SBScreenWakeAnimationController; @class SBDashBoardMainPageView; @class SBMainSwitcherViewController; @class SBHomeScreenViewController; @class WKWebView; @class SBUIController; @class SBManualIdleTimer; @class SBRootFolderView; @class SBDashBoardMainPageContentViewController; @class SBDashBoardViewController; @class SBIconView; @class SBDashBoardMediaArtworkViewController; @class UIWebView; @class SBIdleTimerDefaults; @class SBBacklightController; @class SBDashBoardQuickActionsViewController; @class SBFLockScreenDateView; @class SBFloatingDockPlatterView; @class PHContainerView; @class SBDockView; @class SBDashBoardNotificationAdjunctListViewController; @class SBLockScreenNotificationListController; @class SBLockScreenNotificationListView; @class UITouchesEvent; @class SBHorizontalScrollFailureRecognizer; @class XENDashBoardWebViewController; @class SBLockScreenViewController; @class SBDashBoardNotificationListViewController; @class SBPagedScrollView; @class SBFLockScreenMetrics; @class SBApplication; @class SBDashBoardFixedFooterView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class XENNotificationsCollectionViewController; @class SBUIProudLockIconView; @class SBHomeScreenView; @class SBCoverSheetWindow; @class SBFolderIconBackgroundView; @class SBDashBoardView; @class SBDashBoardMainPageViewController; @class _NowPlayingArtView; @class SBMainStatusBarStateProvider; @class SBMainWorkspace; @class SBAlertWindow; 
