...
@class SBLockScreenBounceAnimator; @class SBUIProudLockIconView; @class SBBacklightController; @class SBCoverSheetWindow; @class SBHorizontalScrollFailureRecognizer; @class SBDashBoardMediaArtworkViewController; @class SBIconView; @class SBScreenWakeAnimationController; @class SBUIController; @class SBFLockScreenMetrics; @class SBDashBoardMainPageContentViewController; @class SBFloatingDockPlatterView; @class SBApplication; @class SBDashBoardViewController; @class SBHomeScreenView; @class PHContainerView; @class SBLockScreenManager; @class SBAlertWindow; @class SpringBoard; @class SBMainSwitcherViewController; @class SBDashBoardTeachableMomentsContainerView; @class XENDashBoardWebViewController; @class SBMainStatusBarStateProvider; @class XENResources; @class SBDashBoardCombinedListViewController; @class SBLockScreenNotificationListView; @class SBDashBoardFixedFooterView; @class SBRootFolderView; @class SBUICallToActionLabel; @class UIWebView; @class SBLockScreenNotificationListController; @class SBDashBoardNotificationAdjunctListViewController; @class SBIdleTimerDefaults; @class SBDashBoardNotificationListViewController; @class SBDockView; @class SBManualIdleTimer; @class _NowPlayingArtView; @class SBDashBoardPageViewController; @class SBFLockScreenDateView; @class SBHomeScreenViewController; @class SBDashBoardView; @class SBDashBoardMainPageViewController; @class SBPagedScrollView; @class SBFolderIconBackgroundView; @class UITouch; @class SBMainWorkspace; @class XENNotificationsCollectionViewController; @class WKWebView; @class SBDashBoardMainPageView; @class SBLockScreenView; @class SBDashBoardQuickActionsViewController; @class SBLockScreenViewController; @class UITouchesEvent; @class SBFluidSwitcherGestureWorkspaceTransaction; 


#line 329 "/Users/matt/iOS/Projects/Xen-HTML/Tweak/XenHTML.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_3beba1b3(int __unused argc, char __unused **argv, char __unused **envp) {
