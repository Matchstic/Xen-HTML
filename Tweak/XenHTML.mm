...
@class SBLockScreenNotificationListView; @class SBApplication; @class UIWebView; @class SBLockScreenBounceAnimator; @class SBUICallToActionLabel; @class SBDashBoardMainPageView; @class XENDashBoardWebViewController; @class SBDashBoardMediaArtworkViewController; @class SBDashBoardView; @class SBDashBoardNotificationAdjunctListViewController; @class SBLockScreenViewController; @class SBLockScreenNotificationListController; @class SBDashBoardMainPageViewController; @class SBMainSwitcherViewController; @class SpringBoard; @class SBDashBoardPageViewController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBBacklightController; @class SBHomeScreenViewController; @class SBFLockScreenDateView; @class SBDockView; @class SBLockScreenView; @class XENNotificationsCollectionViewController; @class PHContainerView; @class SBCoverSheetWindow; @class SBAlertWindow; @class XENResources; @class UITouchesEvent; @class _NowPlayingArtView; @class SBPagedScrollView; @class SBMainWorkspace; @class SBHorizontalScrollFailureRecognizer; @class SBDashBoardCombinedListViewController; @class SBIconView; @class SBDashBoardTeachableMomentsContainerView; @class SBRootFolderView; @class SBIdleTimerDefaults; @class WKWebView; @class SBDashBoardMainPageContentViewController; @class SBHomeScreenView; @class SBLockScreenManager; @class SBUIController; @class SBManualIdleTimer; @class SBFLockScreenMetrics; @class SBDashBoardNotificationListViewController; @class SBFolderIconBackgroundView; @class SBUIProudLockIconView; @class SBMainStatusBarStateProvider; @class SBDashBoardQuickActionsViewController; @class SBFloatingDockPlatterView; @class SBDashBoardViewController; @class SBDashBoardFixedFooterView; @class SBScreenWakeAnimationController; 
