...
@class SBDashBoardView; @class SBDashBoardNotificationListViewController; @class SBDashBoardViewController; @class SBAlertWindow; @class SBHomeScreenView; @class SBPagedScrollView; @class PHContainerView; @class SBDashBoardFixedFooterView; @class SBLockScreenNotificationListController; @class SBFLockScreenDateView; @class SBHomeScreenViewController; @class SBDashBoardTeachableMomentsContainerView; @class SBRootFolderView; @class SBLockScreenNotificationListView; @class SBLockScreenView; @class SBDashBoardMainPageViewController; @class SBDashBoardQuickActionsViewController; @class SBLockScreenViewController; @class UITouch; @class SBFLockScreenMetrics; @class SBDashBoardPageViewController; @class SBCoverSheetWindow; @class UITouchesEvent; @class SBFolderIconBackgroundView; @class SBHorizontalScrollFailureRecognizer; @class SBDashBoardMainPageView; @class SBDashBoardCombinedListViewController; @class SBUIController; @class XENNotificationsCollectionViewController; @class SBMainStatusBarStateProvider; @class SBManualIdleTimer; @class SBDashBoardMainPageContentViewController; @class _NowPlayingArtView; @class SBFloatingDockPlatterView; @class SBUIProudLockIconView; @class SBMainSwitcherViewController; @class SBDockView; @class XENResources; @class SBScreenWakeAnimationController; @class SBMainWorkspace; @class SBIdleTimerDefaults; @class SBUICallToActionLabel; @class SBDashBoardNotificationAdjunctListViewController; @class SBLockScreenManager; @class WKWebView; @class SBIconView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SpringBoard; @class SBLockScreenBounceAnimator; @class XENDashBoardWebViewController; @class UIWebView; @class SBBacklightController; @class SBDashBoardMediaArtworkViewController; @class SBApplication; 
