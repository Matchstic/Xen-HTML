...
@class SBDashBoardMainPageContentViewController; @class SBMainWorkspace; @class SBLockScreenNotificationListView; @class PHContainerView; @class WKWebView; @class SBHomeScreenView; @class SBDashBoardMainPageView; @class SBLockScreenBounceAnimator; @class SBLockScreenNotificationListController; @class SBFLockScreenDateView; @class UITouchesEvent; @class SBLockScreenViewController; @class SBDashBoardFixedFooterView; @class SBDashBoardMainPageViewController; @class SBDashBoardTeachableMomentsContainerView; @class SBHomeScreenViewController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBDashBoardMediaArtworkViewController; @class SBDockView; @class XENResources; @class SBManualIdleTimer; @class SBUIController; @class SBLockScreenManager; @class SBMainSwitcherViewController; @class _NowPlayingArtView; @class SBUICallToActionLabel; @class SBCoverSheetWindow; @class SBUIProudLockIconView; @class SBIconView; @class SBAlertWindow; @class SBDashBoardViewController; @class SBDashBoardCombinedListViewController; @class SBBacklightController; @class SBFLockScreenMetrics; @class SBMainStatusBarStateProvider; @class SBDashBoardNotificationAdjunctListViewController; @class SBFolderIconBackgroundView; @class SpringBoard; @class SBDashBoardPageViewController; @class SBIdleTimerDefaults; @class XENNotificationsCollectionViewController; @class SBScreenWakeAnimationController; @class SBDashBoardNotificationListViewController; @class UIWebView; @class SBDashBoardView; @class SBDashBoardQuickActionsViewController; @class SBApplication; @class SBHorizontalScrollFailureRecognizer; @class SBFloatingDockPlatterView; @class SBRootFolderView; @class XENDashBoardWebViewController; @class SBLockScreenView; @class SBPagedScrollView; 
