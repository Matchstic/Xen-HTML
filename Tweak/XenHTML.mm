...
@class SBManualIdleTimer; @class SBDashBoardMainPageContentViewController; @class SBFloatingDockPlatterView; @class SBDashBoardTeachableMomentsContainerView; @class SBFolderIconBackgroundView; @class SBMainWorkspace; @class SBDashBoardNotificationAdjunctListViewController; @class SBCoverSheetWindow; @class SBFLockScreenDateView; @class UITouchesEvent; @class SBLockScreenBounceAnimator; @class SBHomeScreenViewController; @class SBDashBoardViewController; @class SBDashBoardView; @class SBFLockScreenMetrics; @class SBLockScreenViewController; @class SBDashBoardMainPageViewController; @class XENResources; @class SBUIController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class _NowPlayingArtView; @class SBDashBoardMainPageView; @class SBMainSwitcherViewController; @class SBHomeScreenView; @class SBBacklightController; @class SBDashBoardPageViewController; @class SpringBoard; @class UIWebView; @class SBHorizontalScrollFailureRecognizer; @class SBApplication; @class SBDashBoardQuickActionsViewController; @class XENDashBoardWebViewController; @class SBUIProudLockIconView; @class SBLockScreenView; @class SBLockScreenNotificationListController; @class SBIconView; @class SBLockScreenManager; @class SBLockScreenNotificationListView; @class SBScreenWakeAnimationController; @class XENNotificationsCollectionViewController; @class SBIdleTimerDefaults; @class SBUICallToActionLabel; @class SBDashBoardNotificationListViewController; @class SBMainStatusBarStateProvider; @class PHContainerView; @class SBDashBoardCombinedListViewController; @class SBPagedScrollView; @class SBAlertWindow; @class SBDashBoardMediaArtworkViewController; @class SBDashBoardFixedFooterView; @class WKWebView; @class SBRootFolderView; @class SBDockView; 
