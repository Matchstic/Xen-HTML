...
@class SBDashBoardCombinedListViewController; @class SBIconView; @class SBBacklightController; @class SBCoverSheetWindow; @class SBDashBoardViewController; @class SBDashBoardMediaArtworkViewController; @class SBLockScreenNotificationListView; @class PHContainerView; @class WKWebView; @class SBLockScreenNotificationListController; @class XENNotificationsCollectionViewController; @class SBManualIdleTimer; @class SBFolderIconBackgroundView; @class SBDashBoardQuickActionsViewController; @class _NowPlayingArtView; @class XENResources; @class SBMainSwitcherViewController; @class SBScreenWakeAnimationController; @class SBDockView; @class SBFLockScreenDateView; @class SBRootFolderView; @class SBDashBoardView; @class SBUIController; @class SBDashBoardMainPageView; @class UITouchesEvent; @class SBDashBoardFixedFooterView; @class SBFLockScreenMetrics; @class SBLockScreenView; @class SBHomeScreenViewController; @class SBLockScreenViewController; @class SBLockScreenManager; @class SBPagedScrollView; @class SBMainWorkspace; @class SBDashBoardTeachableMomentsContainerView; @class XENDashBoardWebViewController; @class SBFloatingDockPlatterView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class UIWebView; @class SBDashBoardMainPageContentViewController; @class SBDashBoardNotificationAdjunctListViewController; @class SBUICallToActionLabel; @class SpringBoard; @class SBAlertWindow; @class SBDashBoardMainPageViewController; @class SBHomeScreenView; @class SBIdleTimerDefaults; @class SBUIProudLockIconView; @class SBDashBoardNotificationListViewController; @class SBDashBoardPageViewController; @class SBApplication; @class SBHorizontalScrollFailureRecognizer; @class SBLockScreenBounceAnimator; @class SBMainStatusBarStateProvider; @class UITouch; 
