...
@class SBMainWorkspace; @class SBHomeScreenViewController; @class SBLockScreenManager; @class SBDashBoardNotificationListViewController; @class SBLockScreenView; @class XENNotificationsCollectionViewController; @class SpringBoard; @class SBLockScreenBounceAnimator; @class SBLockScreenNotificationListController; @class SBAlertWindow; @class SBHomeScreenView; @class SBUIController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class UIWebView; @class SBFLockScreenDateView; @class SBFloatingDockPlatterView; @class XENDashBoardWebViewController; @class SBDashBoardPageViewController; @class SBFLockScreenMetrics; @class SBPagedScrollView; @class _NowPlayingArtView; @class SBFolderIconBackgroundView; @class SBDashBoardMainPageViewController; @class SBRootFolderView; @class SBDashBoardTeachableMomentsContainerView; @class PHContainerView; @class SBDashBoardView; @class SBUICallToActionLabel; @class SBUIProudLockIconView; @class SBDashBoardQuickActionsViewController; @class SBDashBoardMediaArtworkViewController; @class SBIconView; @class SBLockScreenNotificationListView; @class SBApplication; @class SBMainSwitcherViewController; @class SBDashBoardNotificationAdjunctListViewController; @class SBDashBoardFixedFooterView; @class XENResources; @class SBDashBoardMainPageView; @class SBBacklightController; @class SBCoverSheetWindow; @class UITouchesEvent; @class SBIdleTimerDefaults; @class SBHorizontalScrollFailureRecognizer; @class WKWebView; @class SBDashBoardMainPageContentViewController; @class SBManualIdleTimer; @class SBDashBoardCombinedListViewController; @class SBLockScreenViewController; @class SBDashBoardViewController; @class SBDockView; @class SBScreenWakeAnimationController; @class SBMainStatusBarStateProvider; 
