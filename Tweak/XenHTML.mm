...
@class PHContainerView; @class SBDockView; @class SBDashBoardMainPageView; @class SBMainWorkspace; @class SBDashBoardNotificationListViewController; @class XENResources; @class SBApplication; @class SBDashBoardMainPageContentViewController; @class SBDashBoardTeachableMomentsContainerView; @class SBLockScreenNotificationListController; @class SBLockScreenView; @class SBUICallToActionLabel; @class SBFloatingDockPlatterView; @class SBIconView; @class SBUIProudLockIconView; @class SBLockScreenNotificationListView; @class SBManualIdleTimer; @class WKWebView; @class SBFolderIconBackgroundView; @class SBCoverSheetWindow; @class SBDashBoardMediaArtworkViewController; @class SBLockScreenBounceAnimator; @class SBUIController; @class SBHomeScreenView; @class SBDashBoardPageViewController; @class SBDashBoardViewController; @class SBDashBoardView; @class SBDashBoardFixedFooterView; @class SBFLockScreenDateView; @class SBBacklightController; @class SBAlertWindow; @class UITouch; @class SBHorizontalScrollFailureRecognizer; @class UIWebView; @class SpringBoard; @class SBHomeScreenViewController; @class SBIdleTimerDefaults; @class SBRootFolderView; @class SBMainSwitcherViewController; @class SBFLockScreenMetrics; @class XENDashBoardWebViewController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBScreenWakeAnimationController; @class SBLockScreenViewController; @class SBDashBoardCombinedListViewController; @class SBPagedScrollView; @class SBDashBoardNotificationAdjunctListViewController; @class SBLockScreenManager; @class UITouchesEvent; @class SBMainStatusBarStateProvider; @class XENNotificationsCollectionViewController; @class _NowPlayingArtView; @class SBDashBoardMainPageViewController; @class SBDashBoardQuickActionsViewController; 
