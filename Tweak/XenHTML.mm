...
@class SBDashBoardQuickActionsViewController; @class SBLockScreenBounceAnimator; @class SpringBoard; @class SBDashBoardNotificationListViewController; @class SBBacklightController; @class SBIdleTimerDefaults; @class SBCoverSheetWindow; @class SBFLockScreenDateView; @class SBDashBoardMainPageView; @class XENResources; @class SBDashBoardNotificationAdjunctListViewController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBUIController; @class SBLockScreenNotificationListView; @class XENNotificationsCollectionViewController; @class SBDashBoardViewController; @class SBFolderIconBackgroundView; @class SBScreenWakeAnimationController; @class SBUIProudLockIconView; @class SBDashBoardMainPageViewController; @class SBDashBoardTeachableMomentsContainerView; @class UITouch; @class SBDashBoardMediaArtworkViewController; @class XENDashBoardWebViewController; @class UIWebView; @class PHContainerView; @class SBLockScreenViewController; @class SBMainSwitcherViewController; @class SBLockScreenManager; @class SBDashBoardPageViewController; @class SBMainWorkspace; @class SBDashBoardMainPageContentViewController; @class SBHomeScreenViewController; @class SBMainStatusBarStateProvider; @class SBDashBoardFixedFooterView; @class SBAlertWindow; @class SBFloatingDockPlatterView; @class SBManualIdleTimer; @class _NowPlayingArtView; @class SBIconView; @class WKWebView; @class SBUICallToActionLabel; @class SBDashBoardView; @class SBHomeScreenView; @class UITouchesEvent; @class SBDockView; @class SBRootFolderView; @class SBApplication; @class SBPagedScrollView; @class SBLockScreenNotificationListController; @class SBDashBoardCombinedListViewController; @class SBHorizontalScrollFailureRecognizer; @class SBFLockScreenMetrics; @class SBLockScreenView; 
