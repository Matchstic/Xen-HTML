...
@class _NowPlayingArtView; @class SBUICallToActionLabel; @class SpringBoard; @class SBCoverSheetWindow; @class SBIconView; @class SBBacklightController; @class XENDashBoardWebViewController; @class SBDashBoardCombinedListViewController; @class SBPagedScrollView; @class SBLockScreenView; @class SBIdleTimerDefaults; @class SBApplication; @class SBDashBoardNotificationListViewController; @class SBDashBoardView; @class SBMainSwitcherViewController; @class SBLockScreenNotificationListController; @class SBDashBoardMainPageViewController; @class UIWebView; @class SBMainWorkspace; @class UITouchesEvent; @class SBDashBoardTeachableMomentsContainerView; @class XENNotificationsCollectionViewController; @class SBFLockScreenDateView; @class SBAlertWindow; @class SBFolderIconBackgroundView; @class SBFLockScreenMetrics; @class SBHomeScreenView; @class SBDashBoardMainPageView; @class SBUIProudLockIconView; @class SBDashBoardNotificationAdjunctListViewController; @class WKWebView; @class SBDashBoardMainPageContentViewController; @class SBUIController; @class SBMainStatusBarStateProvider; @class SBLockScreenManager; @class SBHomeScreenViewController; @class PHContainerView; @class SBLockScreenBounceAnimator; @class SBFloatingDockPlatterView; @class SBLockScreenNotificationListView; @class SBRootFolderView; @class SBHorizontalScrollFailureRecognizer; @class XENResources; @class SBDashBoardPageViewController; @class SBDashBoardQuickActionsViewController; @class SBDashBoardMediaArtworkViewController; @class SBScreenWakeAnimationController; @class SBDashBoardFixedFooterView; @class SBDockView; @class SBDashBoardViewController; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBManualIdleTimer; @class SBLockScreenViewController; 


#line 313 "/Users/matt/iOS/Projects/Xen-HTML/Tweak/XenHTML.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_62db10f5(int __unused argc, char __unused **argv, char __unused **envp) {
    {}
