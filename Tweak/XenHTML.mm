...
@class SBDashBoardMainPageViewController; @class SBUIController; @class SBMainSwitcherViewController; @class SBLockScreenNotificationListController; @class XENNotificationsCollectionViewController; @class SBLockScreenNotificationListView; @class SBRootFolderView; @class SBDashBoardTeachableMomentsContainerView; @class SBLockScreenViewController; @class SBFloatingDockPlatterView; @class SBUIProudLockIconView; @class SBMainWorkspace; @class SBDashBoardMainPageView; @class UITouchesEvent; @class SBIconView; @class SBMainStatusBarStateProvider; @class SBHomeScreenViewController; @class SBDashBoardMainPageContentViewController; @class SBDashBoardMediaArtworkViewController; @class PHContainerView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBLockScreenManager; @class SBDashBoardNotificationListViewController; @class SBIdleTimerDefaults; @class XENDashBoardWebViewController; @class XENResources; @class SBCoverSheetWindow; @class SBHorizontalScrollFailureRecognizer; @class SBPagedScrollView; @class SBDashBoardQuickActionsViewController; @class SBDashBoardFixedFooterView; @class WKWebView; @class SBLockScreenView; @class SBDashBoardCombinedListViewController; @class SBFolderIconBackgroundView; @class SpringBoard; @class SBDashBoardView; @class SBHomeScreenView; @class SBUICallToActionLabel; @class SBManualIdleTimer; @class SBDashBoardViewController; @class SBScreenWakeAnimationController; @class SBLockScreenBounceAnimator; @class UITouch; @class SBDashBoardNotificationAdjunctListViewController; @class _NowPlayingArtView; @class SBBacklightController; @class SBAlertWindow; @class SBDockView; @class SBFLockScreenMetrics; @class UIWebView; @class SBFLockScreenDateView; @class SBApplication; @class SBDashBoardPageViewController; 
...
static __attribute__((constructor)) void _logosLocalCtor_7c3dae07(int __unused argc, char __unused **argv, char __unused **envp) {
