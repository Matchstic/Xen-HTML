...
static void _logos_method$SpringBoard$SBHomeScreenWindow$becomeKeyWindow(_LOGOS_SELF_TYPE_NORMAL SBHomeScreenWindow* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    
    
    _logos_orig$SpringBoard$SBHomeScreenWindow$becomeKeyWindow(self, _cmd);
...
static __attribute__((constructor)) void _logosLocalCtor_bbac2b89(int __unused argc, char __unused **argv, char __unused **envp) {
    {}
