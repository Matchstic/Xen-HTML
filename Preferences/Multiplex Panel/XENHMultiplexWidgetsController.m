//
//  XENHMultiplexWidgetsController.m
//  Preferences
//
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 1) {
        ...
        XENHPickerController2 *mc = [[XENHPickerController2 alloc] initWithVariant:self.variant != kMultiplexVariantHomescreenBackground ? 0 : 2 andDelegate:self andCurrentSelectedArray:self.dataSource];
