//
//  XENHLSNotificationsController.m
//  
//
...
@implementation XENHLSNotificationsController

-(id)specifiers {
    if (_specifiers == nil) {
        NSMutableArray *testingSpecs = [self loadSpecifiersFromPlistName:@"LSNotifications" target:self];
